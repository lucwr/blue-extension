...
function buildUser(input: ResumePromptInput): string {
  return [
    ...
    '',
    '==================================================',
    'PER-ROLE TITLE TAILORING — APPLY THIS',
    '==================================================',
    '',
    'For EACH item in experience[], you MAY rewrite the `title` field so it reads',
    'more relevantly to the JD\'s target role — without changing the company,',
    'dates, or the candidate\'s actual seniority. The goal: stronger ATS keyword',
    'alignment on the role line, while staying truthful.',
    '',
    'HOW TO TAILOR:',
    '- Pull the JD\'s primary role-name vocabulary (e.g. "Backend Engineer",',
    '  "Full-Stack Engineer", "Platform Engineer", "ML Engineer", "Data Engineer",',
    '  "Solutions Engineer", "SRE", "Mobile Engineer", "AI Engineer") and weave',
    '  it into each per-role title where it\'s a TRUTHFUL fit given the bullets.',
    '- The tailored title must still describe the work the candidate actually',
    '  did at that company in that time period (use the bullets as ground truth).',
    '- Mirror the JD\'s exact target-role wording on the MOST RECENT role when',
    '  truthful — that\'s the title ATS scoring weighs heaviest.',
    '- Older roles can be lightly nudged (e.g. "Software Engineer" →',
    '  "Software Engineer, Backend" if the bullets prove backend work), but',
    '  don\'t force-fit a JD-specific stack onto an early-career role.',
    '',
    'HARD RULES (do not violate):',
    '- NEVER up-level seniority beyond what the master profile shows. Junior',
    '  stays Junior, Mid stays Mid, Senior stays Senior, Staff stays Staff,',
    '  Principal stays Principal. Do not invent "Lead" / "Manager" / "Head of"',
    '  / "VP" / "Director" / "Architect" / "Founder" titles the candidate did',
    '  not hold.',
    '- NEVER change the company name, location, startDate, or endDate.',
    '- NEVER invent a stack the bullets don\'t demonstrate. If the bullets',
    '  show only Java/Spring, do not call the role an "ML Engineer".',
    '- NEVER use a title that is anachronistic for the company / time period',
    '  (e.g. "Generative AI Engineer" for a 2015 role).',
    '- Keep the tailored title concise — under ~70 characters, no buzzword',
    '  pile-up. One or two relevant modifiers added to the original title is',
    '  the right size.',
    '',
    'EXAMPLES (master profile title → JD target → tailored title):',
    '- "Software Engineer" → JD "Senior Backend Engineer" (candidate was Mid)',
    '  → "Software Engineer, Backend"  (Mid stays Mid; backend keyword added)',
    '- "Senior AI Software Developer" → JD "Senior Machine Learning Engineer"',
    '  → "Senior AI / ML Engineer"',
    '- "Full-Stack Engineer" → JD "Platform Engineer"',
    '  → "Full-Stack Platform Engineer"',
    '- "Engineering Manager" → JD "Senior Software Engineer"',
    '  → KEEP "Engineering Manager" — never down-level either; tailor bullets',
    '  to surface IC contributions instead.',
    '',
    '==================================================',
...
export const generateResumePrompt: PromptModule<ResumePromptInput> = {
  version: 'generate-resume@2026-06-02.v11-per-role-title-tailoring',
